    ...
    c.extend(l.prototype, {
        pointRange: 0, hasExtremes: function (a) {
            ...
            if (k.length > 99999)d.options.loading = T(i, {
                labelStyle: {backgroundColor: "rgba(255,255,255,0.75)", padding: "1em", borderRadius: "0.5em"},
            ...
            w(J ? a.data : j || k, function (b, c) {
                ...
                a.canvasToSVG();
                S(a, "renderedCanvas");
                if (c)n(b.style, {transition: "opacity 250ms", opacity: 0}), d.loadingShown = !1, y = setTimeout(function () {
